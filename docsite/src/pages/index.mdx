...
* Generate Resources from...
  * [x] Stack
     * [x] [Files On Server](./docs/usage/overview#files-on-server) Stacks from plain folders  
     * [x] [Git-based](./docs/usage/overview#git-repo) Stacks from folders containing git repository
